...
HD_PWD='C:/Users/eduar/XilinxProjects/capstone_upsampleby4/capstone_upsampleby4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log upsampleby4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source upsampleby4.tcl -notrace
