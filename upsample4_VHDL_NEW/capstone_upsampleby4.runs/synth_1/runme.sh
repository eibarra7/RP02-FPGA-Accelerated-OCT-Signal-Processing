...
HD_PWD='C:/Users/eduar/XilinxProjects/capstone_upsampleby4/capstone_upsampleby4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log upsampleby4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source upsampleby4.tcl
